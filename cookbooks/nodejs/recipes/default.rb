...
bash "install npm libs" do
  cwd "/home/vagrant/app"
  code <<-EOH
  echo "-> Installing q (global)"
  npm install -g q
  echo '-> installing grunt-cli (global)'
  npm install -g grunt-cli 
  echo '-> installing forever (global)'
  npm install -g forever 
  echo '-> installing Yeoman (global)'
  npm install -g yo 
  echo '-> installing HiRedis [Redis Client]'
  npm install hiredis redis
  echo '-> installing Cradle [CouchDB Client]'
  npm install cradle
  EOH
end
