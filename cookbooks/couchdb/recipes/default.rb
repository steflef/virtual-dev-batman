...
service "couchdb" do
  if platform_family?("rhel","fedora")
    start_command "sudo /etc/init.d/couchdb start &> /dev/null"
    stop_command "sudo /etc/init.d/couchdb stop &> /dev/null"
    restart_command "sudo /etc/init.d/couchdb restart &> /dev/null"
    status_command "/etc/init.d/couchdb status &> /dev/null"
